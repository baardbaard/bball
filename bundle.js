...
var _user$project$Main$edit = F2(
	function (model, id) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: newPlayers, plays: newPlays, name: '', playerId: _elm_lang$core$Maybe$Nothing, editMode: false});
	});
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {players: a, name: b, playerId: c, plays: d, editMode: e};
	});
	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'Cancel':
				return _elm_lang$core$Native_Utils.update(
					model,
					{name: '', playerId: _elm_lang$core$Maybe$Nothing, editMode: false});
			default:
...
var _user$project$Main$playerSection = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$playerListHeader,
