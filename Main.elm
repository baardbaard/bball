...
{--
    Todo: Add edit class to list item and input when in Edit-mode
    - Set class of input and li based on model state
--}
-- model
...
update msg model =
    case msg of
        Edit player ->
            { model | name = player.name, playerId = Just player.id, editMode = True }
        ...
        Cancel ->
            { model | name = "", playerId = Nothing, editMode = False }
